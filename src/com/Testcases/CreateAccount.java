...
public class CreateAccount {
		...
		//********************************* Methods Implementation *******************************
			...
			//============================================================================
			/*
			 * Method Name:Verify_Invalid_Email_Error(String EmailId)
			 * 
		  ...
		  public static void Verify_Invalid_Email_Error(String emailId){
			...
			//waiting for 10 seconds after clicking button to let the page loaded and display message
			  ...
			  //verifying error message with expected and actual values 
		       ...
		       //verifying weather the bag color of the email address Textbox is changing or not 
		...
		//********************************* Methods Implementation *******************************
				...
				//============================================================================
				/*
				 * Method Name:Verify_With_Valid_Email(String EmailId)
				 * 
				 ...
				 * 
				 * Input Parameter:Valid EmailID :abcd.lat@gmail.com
				 * 
				 * OutPut Parameter:
				 * 
				 * Dependency:
